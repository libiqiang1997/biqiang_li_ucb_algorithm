...
class UCB(object):
    def __init__(self, sigma_noise, k, delta):
    ...
    def select_arm(self, arms):
        ...
        for arm in arms:
            if self.chosen_counts[arm.arm_id] > 0:
                ...
                self.ucbs[arm.arm_id] = estimated_reward + alpha
    ...
    def update_model(self, choice, round_reward):
        # # print('self.matrix:\n', self.matrix)
